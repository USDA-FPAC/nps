    ...
    <main id="main-content" tabindex="-1">
      ...
      <div class="fds-section">
        <div class="fds-section__bd">
          ...
          <!-- Popover START -->
          <div class="fds-popover fds-popover--tr fds-popover--size-large" id="table-help-popover-123" aria-hidden="true">
            <div class="fds-popover__content">
              <div class="fds-popover__hd">
                <div class="fds-level@m fds-level--justify-between">
                  <h2 class="fds-popover__title">Table Help</h2>
          ...
          <table class="fds-table">
            <caption>
              <div class="fds-level@m fds-level--justify-between">
                ...
                <span class="fds-m-l--xs">
                  <button @click="showPopover('table-help-popover-123')" class="fds-btn fds-btn--flat"
                    data-behavior="toggle-popover"
                    data-target="table-help-popover-123">
                    <svg class="fds-icon fds-icon--size-1" aria-hidden="true" focusable="false" role="img" fill="#494440" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
              ...
              <tr v-for="(results, paymentId) in searchData" v-bind:key="paymentId">
                ...
                <td>
                  <div class="fds-level fds-level--justify-right fds-level--gutter-xs">
                    <button v-for="action in results.actions" :key="action.id" :class="'fds-btn fds-btn--small ' +action.btnClass">{{ action.label }}</button>
                  </div>
                </td>
              </tr>
            </tbody>
